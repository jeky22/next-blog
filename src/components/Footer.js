  ...
  return (
    <Box>
      ...
      <Box flex={1} className={classes.main} maxWidth={600} >
        ...
        <Typography variant="body1" className={classes.typo}>현재는 거창한 업무성과보다 사용자의 작은 문제해결에 끝까지 몰입할 수 있는 신입 개발자입니다. 이런 저의 <b className={classes.typoBold}>성장가능성을 믿고 이끌어줄 회사</b>를 찾고 있습니다. </Typography>
      </Box>
